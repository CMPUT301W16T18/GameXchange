...
public class UserTest extends TestCase {
    ...
    public void testSetEmail() throws Exception {
        ...
        assertEquals("Returned User ID did not return the expected value", "New Email", user.getId());
        //test empty string
        user.setEmail("");
